...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.wf.grab.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.wf.grab.security.DomainUserDetailsService", "createSpringSecurityUser");
    }
}
